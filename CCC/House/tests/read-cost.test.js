...
const BUCKETS = ['house-budgets', 'house-config', 'house-receipts', 'house-tenants', 'house-leases', 'house-rent', 'house-maintenance'];
...
(async () => {
  ...
  ok('receipts never fetched by the poll', [b['house-receipts'], l['house-receipts']], [0, 0]);
